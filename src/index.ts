interface Subject {
    ...
    grade_upto: string;
    units: number | false;
    lessons: number | false;
    topics: number | false;
    classes: string[];
    total_students: number | false;
...
const cards: Subject[] = [subject_1, subject_2, subject_3, subject_4];
            ...
            <div class="card-content">
                ...
                <div class="card-right-content">
                    ...
                    <div class="subject-class">
                        ...
                        <div>${grade} <span class="grade-plus">${grade_upto}</span></div>
                    </div>
                    <div class="units-lessons-topics">
                        ${units ? `<div><span>${units}</span> Units</div>` : ``}
                        ${lessons ? `<div><span>${lessons}</span> Lessons</div>` : ``}
                        ${topics ? `<div><span>${topics}</span> Topics</div>` : ``}
                    </div>
                    <div>
                    ...
                    <div class="students-dates">
                        ${!total_students ? `` : `
                            <div>${total_students} Students</div>
                            ${!date_from ? `` : `
                                <div class="seperator"></div>
